...
import im.maqu.matk.enums.EApnType;
import im.maqu.matk.enums.ENetworkType;
import im.maqu.matk.enums.EOperatorType;
...
public class UtilNetwork {
	...
	public static String getIpAddress(Context context) {
		ENetworkType type = getNetworkType(context);
		String ipAddress = null;

		if(type == ENetworkType.NETWORK_WIFI) {
